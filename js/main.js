...
fetch(`http://api.openweathermap.org/data/2.5/weather?q=${cityName}&units=metric&appid=16b6754ad8952f29340c4a77785bfb10&lang=uk`)
  ...
  .then(function (data) {
    ...
    document.querySelector('.wind').innerHTML = '<img src="https://img.icons8.com/ios-filled/50/26e07f/azimuth--v5.png"/>' + ' ' + data.wind.speed + 'м/с';
    document.querySelector('.wind_deg').innerHTML = '<img src="https://img.icons8.com/ios/50/26e07f/windsock.png"/>' + ' ' + data.wind.deg + '&deg;';
